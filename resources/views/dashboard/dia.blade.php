...
<body>
    ...
    <div class="big-posts-area mb-50">
        <div class="container">
            ...
            <?php
            foreach ($produto as $li):
              $mudatemp=  $li->dataabert;
...
if($mdate==date('d/m/Y')){
              ...
              <div class="row align-items-center ">
                  ...
                  <div class="col-12 col-md-6">
                      <h4 style="color:rgb(18, 46, 61);">Ofertas do Dia</h4>
                      <div class="big-post-thumbnail mb-50" style="margin-top:20px;">
                          <img  style="border-radius: 8px; width: 330px;
  height: 232px;" src="uploads/<?php echo $li->img; ?>" alt="">
                      </div>
                  </div>
                  <div class="col-12 col-md-6">
                      <div class="big-post-content text-center mb-50">
                          <a href="#" class="post-tag" style="color:rgb(18, 46, 61);">  <?php echo $li->nome; ?></a>
                                          <a href="#" class="post-title"><?php echo $li->valor1; ?></a><a href="#" class="post-title" style="font-size:25px; color:red;"> Por  <?php echo $li->valor2; ?> - <?php echo $li->analogia; ?></a>
                          <div class="">
                              <a href="#" class="" style="color: #7a7a7a;
                              font-size: 13px;"> Data da publicação: <?php echo $mdate;?> </a>

                          </div>
                          <p style="color:rgb(18, 46, 61);  margin-top:10px;"><?php echo $li->descricao; ?>.</p>
                      </div>
                  </div>
              </div>
              <?php
